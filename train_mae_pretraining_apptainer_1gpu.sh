...
exec apptainer exec --nv \
  ...
  bash -lc '
    ...
    exec torchrun --standalone --nproc_per_node=1 -m mae_pretraining.run_pretraining \
      data.base_data_dir=/mnt/data4 \
      data.dataset_names=all_train_plain_v3 \
      common.output_dir=/mnt/data4/mae_pretraining_runs/run_001_1gpu \
      common.log_dir=/mnt/data4/mae_pretraining_runs/run_001_1gpu/logs
  '
