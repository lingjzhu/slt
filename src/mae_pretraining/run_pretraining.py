...
from .train import main as pretrain
from .utils.misc import reformat_logger
...
class CommonConfig:
    ...
    bf16: bool = field(default=False, metadata={"help": "Use bf16 automatic mixed-precision"})
