...
export WANDB_NAME="${WANDB_NAME:-t5_signhiera_csl_daily}"
export TOKENIZERS_PARALLELISM=false

OUTPUT_DIR="${OUTPUT_DIR:-/mnt/data4/sign_t5_runs/run_csl_daily}"
...
exec torchrun --standalone --nproc_per_node=1 -m t5_slt.train \
